...
class SpiderDownload:
    def __init__(self,urls,localdir,exlude_dir=[""]):
        ...
        self.header={'Host': 'mirrors.kernel.org',
           'Upgrade-Insecure-Requests': '1',
           'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.88 Safari/537.36'
        }
    ...
    def _DoDownloadFile(self,data):
        ...
        try:
            ...
            localdir = localdir + parsed.path[parsed.path.find("releases"):]
            ...
            if not os.path.exists(localdir+data.link):
                ...
                print("Exsits "+ data.parent + data.link + " at " + localdir+data.link)
...
if __name__ == "__main__":
    ...
    sd = SpiderDownload(["http://mirrors.kernel.org/fedora-buffet/archive/fedora/linux/releases/29/"],"E:\\Fedora29\\fedora\\",exclude)
    #st = int(time.time())
    #sd.GetAllSize(True)
